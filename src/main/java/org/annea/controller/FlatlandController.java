...
import org.annea.flatland.Scenario;
import org.annea.gui.observers.GraphHelper;
import org.annea.runner.FlatlandProblemRunner;
import org.annea.solvers.AbstractSolver;
import org.annea.solvers.FlatlandSolver;
...
public class FlatlandController extends AbstractController implements Initializable, GraphHelper {
    ...
    private void draw() {
        ...
        // Get the grid
        org.annea.flatland.Cell[][] grid = runner.getGrid();
